...
export function getEmailTemplate(
  ...
  switch (key) {
      ...
      return {
        ...
        html: wrap(`
          ...
          <ol style="padding-left:20px;line-height:1.8;">
            ...
            <li>Book a <strong>free trial session</strong> so we can see ${lead.childName ?? "your player"} in action</li>
            <li>We'll create a personalised development plan</li>
          </ol>
          ${cta("Book a Free Trial Session", bookUrl)}
    ...
    case "followup_day1":
      return {
        subject: `${lead.firstName}, did you see our free trial offer?`,
        html: wrap(`
          ...
          <p>Our free trial sessions fill up fast, and it's the best way to see if ${BUSINESS_NAME} is right for ${lead.childName ?? "your player"}.</p>
          <p><strong>What's included in the free trial:</strong></p>
          ...
          ${cta("Book Your Free Trial", bookUrl)}
    ...
    case "followup_day3":
      return {
        ...
        html: wrap(`
          ...
          ${cta("Claim Your Free Trial + Plan", bookUrl)}
          <p>— ${COACH_NAME}</p>
        `),
      };
    ...
    case "followup_day7":
      return {
        subject: `Last chance: free trial for ${lead.childName ?? "your player"}`,
        html: wrap(`
          <h2 style="margin:0 0 8px;">Hi ${lead.firstName},</h2>
          <p>This is my last email about the free trial — I don't want to clog your inbox!</p>
          ...
          <p><strong>Quick recap of what you get — completely free:</strong></p>
          <ul style="padding-left:20px;line-height:1.8;">
